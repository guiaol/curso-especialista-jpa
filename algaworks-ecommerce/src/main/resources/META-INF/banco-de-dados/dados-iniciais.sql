...
insert into produto (id, versao, nome,  preco, data_criacao, ativo, descricao) values (3, 0, 'Câmera GoPro Hero 7', 1400.0, date_sub(sysdate(), interval 1 day), 'SIM', 'Desempenho 2x melhor.');
